        ...
        <div class="card-body">
            <form id="frmAdd" role="form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <p for="example-text-input" class="form-control-label required">Tên sản phẩm </p>
                            <input class="form-control" type="text" value="{{!empty($data['name'])?$data['name']:''}}" name="name" id="name" placeholder="Nhập tên sản phẩm..." />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <p for="example-text-input" class="form-control-label required">Mã sản phẩm</p>
                            <input class="form-control" type="text" value="{{!empty($data['code'])?$data['code']:''}}" name="code" id="code" placeholder="Nhập mã sản phẩm..." />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <p for="example-text-input" class="form-control-label required">Thương hiệu</p>
                            <input class="form-control" type="text" value="{{!empty($data['trademark'])?$data['trademark']:''}}" name="trademark" id="trademark" placeholder="Nhập thương hiệu..." />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <p for="example-text-input" class="form-control-label required">Giá sản phẩm</p>
                            <input class="form-control" type="text" value="{{!empty($data['price'])?$data['price']:''}}" name="price" id="price" placeholder="Nhập giá sản phẩm..." />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <p for="example-text-input" class="form-control-label required">Mã giảm giá</p>
                            <input class="form-control" type="text" value="{{!empty($data['sale'])?$data['sale']:''}}" name="sale" id="sale" placeholder="Nhập mã giảm giá..." />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <br>
                        @if(!empty($data['image']))
                        <img id="show_img" src="{{url('/file-image-client/product/')}}/{{$data['image']}}" alt="Image" style="width:150px">
                        @else
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <p for="example-text-input" class="form-control-label">Thông tin sản phẩm</p>
                            <textarea class="form-control" type="text" rows="10" cols="30" name="decision" id="decision" placeholder="Thông tin sản phẩm...">{{!empty($data['decision'])?$data['decision']:''}}</textarea>
                        </div>
                    </div>
